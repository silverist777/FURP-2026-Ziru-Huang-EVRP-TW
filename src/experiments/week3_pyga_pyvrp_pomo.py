...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "src" / "results" / "week3"
...
from vrptw_support import SolomonInstance, check_solomon_actions, parse_solomon_instance  # noqa: E402
...
def aggregate(args: argparse.Namespace) -> None:
    ...
    summary_md = args.output_dir / "week3_summary.md"
    write_summary_markdown(summary_md, records, summary)
    plot_outputs(args.output_dir, records, summary)
...
def plot_outputs(output_dir: Path, records: list[dict[str, str]], summary: list[dict[str, Any]]) -> None:
    import matplotlib
    ...
    plot_pyga_convergence(output_dir, records, plot_dir, plt)
...
def plot_pyga_convergence(output_dir: Path, records: list[dict[str, str]], plot_dir: Path, plt) -> None:
    pyga_rows = [
